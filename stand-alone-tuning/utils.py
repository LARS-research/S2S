...
def plot_config(args):
    out_str = "\noptim:{}, loss:{}, lr:{}, in_dropout:{}, hd_dropout:{}, d:{}, decay_rate:{}, lamb:{}, train_batch_size:{}, n_epoch:{}\n".format(
            args.optim, args.loss, args.lr, args.input_dropout, args.hidden_dropout, args.n_dim, args.decay_rate, args.lamb, args.n_batch, args.n_epoch)
    print(out_str)
...
#        args.lr = 0.0009267003174594345
#        args.input_dropout = 0.3740
#        args.hidden_dropout = 0.4513
#        args.n_batch = 128
...
#        # hyperOpt on ART under: adam, binary cross entropy loss, batch/drop, nCP0.348
#        args.lr = 0.022648328901061873
#        args.input_dropout = 0.33521052684229835
#        args.hidden_dropout = 0.8511926654575587
#        args.n_batch = 1024
#        args.decay_rate = 0.9901677215577694  
#        args.n_dim = 512  
...
#        # hyperOpt on ART under: adam, binary cross entropy loss, batch/drop, nCP0.667
#        args.lr = 0.002083309499375528
#        args.input_dropout = 0.00039457865494124666
#        args.hidden_dropout = 0.08157974207201771
#        args.n_batch = 128
#        args.decay_rate = 0.992805500299218
...
#        #GETD
#        args.lr = 0.0008658318809880197
#        args.input_dropout = 0.12747824547053027
#        args.hidden_dropout = 0.501929359180091
#        args.n_batch = 128
#        
#        args.n_dim = 512  
#        args.decay_rate = 0.99
